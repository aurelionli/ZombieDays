...
namespace FPS
{
    public class SmgWeapon :BaseWeapon
    {
        protected Transform Scope01Mesh;
        protected Transform Scope02Mesh;
        protected Transform Scope03Mesh;
        protected Transform Scope04Mesh;

        protected SkinnedMeshRenderer scope01Skin;
        protected SkinnedMeshRenderer scope02Skin;
        protected SkinnedMeshRenderer scope03Skin;
        protected SkinnedMeshRenderer scope04Skin;
        ...
        {
            InitListenEvent();
            resuableData.weaponType = WeaponType.Smg;
