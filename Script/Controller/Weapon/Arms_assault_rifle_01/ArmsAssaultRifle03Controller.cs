...
namespace FPS
{
    public class ArmsAssaultRifle03Controller : ArmsWeapon
    {
        ...
        /* private Transform Scope01Mesh;
         ...
         private Transform assault_rifle_03_iron_sights;
        ...
        protected override void Awake()
        {
           ...
           /* silencerMode = false;
            ...
            auto = true;
            //2.加载该枪的数据
            bwData = FindObjectOfType<PlayerController>().player_SO.AAR03Data;
            weaponType = WeaponType.Arms;*/
            bwData = IC.GetData<Player_SO>().AAR03Data;
       ...
       /* protected override void Start()
        ...
        protected override void InitFindGameObject()
        {
            ...
            assault_rifle_03_iron_sights = GameTools.GetSingleComponentInChild<Transform>(gameObject, "assault_rifle_03_iron_sights");
       ...
       /* private void TriggerEvent_WeaponSilencer(object data)
        ...
        protected override void TriggerEvent_ChangeWeaponScope(object data)
        {
            ...
            switch (i)
            {
                case -1:
                    ...
                    aimMode = 0;
                    assault_rifle_03_iron_sights.gameObject.SetActive(true);
                    break;
                case 0:
                    SetMeshTrue(0);
                    break;
        ...
        protected override void SetMeshTrue(int i)
        {
            ...
            assault_rifle_03_iron_sights.gameObject.SetActive(false);
        }
        #endregion
